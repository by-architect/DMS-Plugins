...
// This file is deliberately free of Signal: it is the framing layer, and exists
// unchanged in every bridge. Everything service-specific lives in rpc.go /
...
type chatObj struct {
	...
	// the shell knowing anything about Signal.
