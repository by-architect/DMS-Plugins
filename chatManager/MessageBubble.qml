    ...
    StyledRect {
        ...
        MouseArea {
            ...
            onClicked: {
                ...
                root.chatCore.fetchMedia(root.chatCore.activeProvider, root.chatCore.activeChatId, root.message.id, path => {
                    if (path)
        ...
        Row {
            ...
            DankActionButton {
                ...
                visible: root.chatCore.activeSupports("reply")
            ...
            DankActionButton {
                ...
                tooltipText: root.fromMe && root.chatCore.activeSupports("revoke") ? I18n.tr("Delete for everyone") : I18n.tr("Delete")
